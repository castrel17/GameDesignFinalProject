...
public class Level2SongManager : MonoBehaviour
{
    public float bpm;
     ...
     void Awake()
    {
        if (manager == null)
        {
            ...
            if (manager == null)
                Debug.LogError("Level2SongManager: no Level2Manager found in scene!");
        }
    }

    void Start()
    {
        manager = GameObject.Find("GameManager").GetComponent<Level2Manager>();
