...
public class HoldNoteController2 : MonoBehaviour
{
    ...
    public HoldNoteStart2 startNote;
    public HoldNoteEnd2 endNote;
    ...
    void Start()
    {
        songManager = GetComponentInParent<Level1SongManager>();
    ...
    public void Initialize(float startBeat, float endBeat, Vector2 startPos, Vector2 endPos, Level1SongManager songManager)
    {
